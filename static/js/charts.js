...
function buildCharts(sample) {
  ...
  // D2.2. Create the layout for the bubble chart.
    ...
    var gaugeData = [{
      domain: {x: [0, 1], y: [0,1]},
      value: washing,
      title: {text: "<span>Belly Button Washing Frequency</span><br><span style='font-size:0.8em'>Scrubs per Week</span>"},
      type: "indicator",
      mode: "gauge+number",
      gauge: {
        bar: {color: "black"},
